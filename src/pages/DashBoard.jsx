              ...
              <div className="row">
                ...
                <div className="col-sm-8">
                  <div className="pt-4">
                    ...
                    <div className="mt-4">
                      <a href="javascript: void(0);" className="btn btn-primary waves-effect waves-light btn-sm">View Profile <i className="mdi mdi-arrow-right ms-1" /></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="card-body">
              ...
              <div className="row">
                <div className="col-sm-6">
                  ...
                  <h3>$34,252</h3>
                  <p className="text-muted"><span className="text-success me-2"> 12% <i className="mdi mdi-arrow-up" /> </span> From previous period</p>
                  <div className="mt-4">
                    <a href="javascript: void(0);" className="btn btn-primary waves-effect waves-light btn-sm">View More <i className="mdi mdi-arrow-right ms-1" /></a>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="mt-4 mt-sm-0">
                    <div id="radialBar-chart" data-colors="[&quot;--bs-primary&quot;]" className="apex-charts" />
                  </div>
                </div>
              </div>
