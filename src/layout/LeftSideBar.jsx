      ...
      <ul className="metismenu list-unstyled" id="side-menu">
        ...
        <li>
          ...
          <ul className="sub-menu" aria-expanded="false">
            ...
            <li><a href="dashboard-job.html"><span className="badge rounded-pill text-bg-success float-end" key="t-new">New</span> <span key="t-jobs">Jobs</span></a></li>
          </ul>
        </li>
        <li>
          <a href="javascript: void(0);" className="has-arrow waves-effect">
        ...
        <li>
          ...
          <ul className="sub-menu" aria-expanded="false">
            ...
            <li><a href="ui-utilities.html"><span key="t-utilities">Utilities</span> <span className="badge rounded-pill bg-success float-end" key="t-new">New</span></a></li>
          </ul>
        </li>
        <li>
          <a href="javascript: void(0);" className="waves-effect">
